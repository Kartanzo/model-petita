...
const fieldBase =
  'w-full h-12 rounded-xl border border-border bg-panel px-3 text-[15px] text-text placeholder:text-muted/60 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 outline-none transition';
